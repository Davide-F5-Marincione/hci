...
\begin{figure}[H]
	\centering
	\includegraphics[width=.57\textwidth]{img/storyboards/storyboard_overcrowding.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.53\textwidth]{img/storyboards/storyboard_donations.png}
