...
\begin{figure}[H]
	\centering
 	\includegraphics[width=.8\textwidth]{img/analysis/age_distribution.png}
...
\begin{figure}[H]
	\centering
 	\includegraphics[width=.8\textwidth]{img/analysis/android_v_ios.png}
...
\begin{figure}[H]
	\centering
 	\includegraphics[width=.8\textwidth]{img/analysis/users_by_means_of_transport_by_device.png}
...
\begin{figure}[H]
	\centering
 	\includegraphics[width=.8\textwidth]{img/analysis/users_by_means_of_transport_by_province.png}
...
\begin{figure}[H]
	\centering
 	\includegraphics[width=.8\textwidth]{img/analysis/disservices_reports.png}
