...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	%\vfill\vfill
	\includegraphics[width=0.2\textwidth]{logo-bw.pdf}\qquad\includegraphics[width=0.2\textwidth]{logo-app.pdf}\\[1cm]% Include a department/university logo - this will require the graphicx package

	%----------------------------------------------------------------------------------------

	{\large June 8, 2023} % Date, change the \today to a set date if you want to be precise
...
\begin{figure}[H]
	\centering
	\subfloat[First Iteration, Early]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/home/home2.png}\label{fig:home2}
	}\hspace{0.5pt}
	\subfloat[First Iteration, Late]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/home/home4.png}\label{fig:home4}
	}
	\hspace{0.5pt}
	\subfloat[Second Iteration]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/home/home5.png}\label{fig:home5}
	}\hspace{0.5pt}
	\subfloat[Third Iteration]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/home/home6.png}\label{fig:home6}
	}
...
\begin{figure}[H]
	...
	\subfloat[First Iteration]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/nav/nav1.png}\label{fig:nav1}
	}\hspace{0.5pt}
	\subfloat[Second Iteration, Early]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/nav/nav2.png}\label{fig:nav2}
	}
	\hspace{0.5pt}
	\subfloat[Second Iteration, Late]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/nav/nav3.png}\label{fig:nav3}
	}\hspace{0.5pt}
	\subfloat[Third Iteration]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/nav/nav5.png}\label{fig:nav5}
	}
	\caption{
...
\begin{figure}[H]
	\centering
	\subfloat[Route Selection, Early]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/path/path1.png}\label{fig:path1}
	}\hspace{0.5pt}
	\subfloat[Roundel]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/path/watch1.png}\label{fig:watch1}
	}
	\hspace{4.5pt}
	\subfloat[Route Selection, Final]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/path/path5_select.png}\label{fig:path5_select}
	}\hspace{0.5pt}
	\subfloat[Reporting Screen]{
		\includegraphics[width=0.30\textwidth, height=0.35\textheight, keepaspectratio]{img/prototype/path/path5.png}\label{fig:path5}
	}
	\caption{
...
The application itself, being in its final version, was tested with users four times. From these evaluations, except smaller critics on the matter of aesthetics (of which nil can be done about), we were left fairly satisfied of our work, as almost no major problems were found.
